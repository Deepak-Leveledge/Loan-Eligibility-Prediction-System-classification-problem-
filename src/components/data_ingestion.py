## Data ingestion is for reading the data from the source 
...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        logging.info("Entered The data ingestion methods to the data ingestions")

        try:
            df=pd.read_csv('notebook/data/loan.csv')
            logging.info("Reading the dataset  is done ")
